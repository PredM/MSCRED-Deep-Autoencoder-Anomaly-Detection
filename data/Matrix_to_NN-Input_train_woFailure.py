...
def main():
    ...
    full_data_set = importSignatureMatrix2(config.directoryname_matrix_data + "train_noFailure/")
    config.path + config.directoryname_matrix_data + "_epsi_train_noFailure/"
    ...
    np.save(config.path +'training_data_set_4_epsi_trainWoFailure.npy', curr_xTrainData)
